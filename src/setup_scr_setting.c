...
void setup_scr_setting(lv_ui *ui)
{
    ...
    lv_obj_set_pos(ui->setting_label_1, 183, 217);
    lv_obj_set_size(ui->setting_label_1, 100, 32);
    ...
    lv_obj_set_style_text_font(ui->setting_label_1, &lv_font_montserratMedium_16, LV_PART_MAIN|LV_STATE_DEFAULT);
