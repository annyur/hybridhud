...
void setup_scr_bluetooth(lv_ui *ui)
{
    ...
    lv_obj_set_pos(ui->bluetooth_btn_back, 183, 383);
    ...
    lv_obj_set_style_radius(ui->bluetooth_btn_back, 5, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->bluetooth_bt_sw_enable, 133, 106);
    lv_obj_set_size(ui->bluetooth_bt_sw_enable, 40, 20);
    ...
    lv_obj_set_style_radius(ui->bluetooth_bt_sw_enable, 10, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_radius(ui->bluetooth_bt_sw_enable, 10, LV_PART_KNOB|LV_STATE_DEFAULT);
    ...
    lv_obj_set_size(ui->bluetooth_bt_list_devices, 329, 202);
    ...
    lv_obj_set_pos(ui->bluetooth_bt_btn_scan, 250, 86);
    ...
    lv_obj_set_style_radius(ui->bluetooth_bt_btn_scan, 5, LV_PART_MAIN|LV_STATE_DEFAULT);
