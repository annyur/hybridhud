...
void setup_scr_race(lv_ui *ui)
{
    ...
    lv_obj_set_style_border_opa(ui->race_cont_G, 255, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_color(ui->race_cont_G, lv_color_hex(0x2195f6), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->race_meter_G, 93, 93);
    lv_obj_set_size(ui->race_meter_G, 280, 280);
    ...
    lv_obj_set_pos(ui->race_label_7, 357, 198);
    lv_obj_set_size(ui->race_label_7, 16, 69);
    ...
    lv_obj_set_style_text_font(ui->race_label_7, &lv_font_montserratMedium_16, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->race_label_6, 93, 198);
    lv_obj_set_size(ui->race_label_6, 16, 69);
    ...
    lv_obj_set_style_text_font(ui->race_label_6, &lv_font_montserratMedium_16, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->race_label_G_top, 198, 93);
    ...
    lv_obj_set_style_text_font(ui->race_label_G_top, &lv_font_montserratMedium_16, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->race_label_G_down, 196, 357);
    ...
    lv_obj_set_style_text_font(ui->race_label_G_down, &lv_font_montserratMedium_16, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->race_label_G_right, 330, 225);
    ...
    lv_obj_set_style_text_font(ui->race_label_G_right, &lv_font_montserratMedium_16, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->race_label_left, 61, 225);
    ...
    lv_obj_set_style_text_font(ui->race_label_left, &lv_font_montserratMedium_16, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->race_label_3, 88, 0);
    ...
    lv_obj_set_pos(ui->race_label_2, -12, 283);
    ...
    lv_obj_set_style_text_font(ui->race_label_2, &lv_font_montserratMedium_48, LV_PART_MAIN|LV_STATE_DEFAULT);
