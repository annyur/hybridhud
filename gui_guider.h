...
typedef struct
{
	...
	lv_obj_t *main;
	bool main_del;
	lv_obj_t *main_arc_rpm;
	lv_obj_t *main_meter_speed;
	...
	lv_obj_t *main_label_rpm_number;
	lv_obj_t *main_label_time;
	lv_obj_t *main_label_temp;
	lv_obj_t *main_slider_energy;
	lv_obj_t *main_label_speed_number;
	lv_obj_t *main_label_energy_number;
	lv_obj_t *main_label_energy_number_2;
	lv_obj_t *main_label_oil_number;
	lv_obj_t *main_label_trip;
